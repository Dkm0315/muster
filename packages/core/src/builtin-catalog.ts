...
const BUILTIN_MCP_SERVERS: readonly BuiltinMcpCatalogEntry[] = [
  ...
  mcp("figma", "design", "muster", "Figma remote MCP for design file and component context through OAuth.", "high", "muster mcp install figma", { auth: "oauth", setupUrls: ["https://mcp.figma.com/mcp", "https://www.figma.com/developers/api"], notes: ["Remote OAuth MCP discovered from the local Codex Figma plugin manifest.", "Keep file keys and design assets scoped to the current task."], install: { transport: { kind: "http", url: "https://mcp.figma.com/mcp" }, auth: "oauth", oauth: { setupUrl: "https://mcp.figma.com/mcp", clientName: "Muster" }, limits: { toolTimeoutMs: 30000, maxResultChars: 12000 } } }),
